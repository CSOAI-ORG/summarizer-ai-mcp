<!-- mcp-name: io.github.CSOAI-ORG/summarizer-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/summarizer-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/summarizer-ai-mcp)](https://pypi.org/project/summarizer-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/summarizer-ai-mcp)](https://pypi.org/project/summarizer-ai-mcp/)
...
```json
{
  "mcpServers": {
    "summarizer-ai-mcp": {
      "command": "uvx",
      "args": ["summarizer-ai-mcp"]
    }
  }
}
```

Or: `pip install summarizer-ai-mcp` then run the `summarizer-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `summarize_text` to …"
- "Use `extract_key_points` to …"
- "Use `generate_abstract` to …"
